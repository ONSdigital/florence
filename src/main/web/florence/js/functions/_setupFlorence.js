function setupFlorence(){
  ...
  $('head').prepend('<link href="http://localhost:8081/florence/css/third-party/epiceditor/base/epiceditor.css" rel="stylesheet" type="text/css">');
  $('head').prepend('<link href="http://localhost:8081/florence/css/third-party/epiceditor/editor/epic-dark.css" rel="stylesheet" type="text/css">');
  $('head').prepend('<link href="http://localhost:8081/florence/css/third-party/epiceditor/preview/github.css" rel="stylesheet" type="text/css">');
