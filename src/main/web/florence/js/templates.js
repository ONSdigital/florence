...
templates['chartBuilder'] = template({"1":function(depth0,helpers,partials,data) {
    ...
    return "            <option value=\"year\">Yearly</option>\n            <option value=\"quarter\">Quarterly</option>\n            <option value=\"month\">Monthly</option>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "<div class=\"markdown-editor chart-builder\" xmlns=\"http://www.w3.org/1999/html\">\n  <div class=\"markdown-editor__header\">\n    <h1>Chart Builder</h1>\n  </div>\n  <div class=\"markdown-editor__content\">\n    <div id=\"wmd-preview\" class=\"wmd-panel wmd-preview\">\n      <div id=\"chart\"></div>\n    </div>\n    <div id=\"wmd-edit\" class=\"wmd-panel wmd-preview\">\n\n      <input type=\"text\" id=\"chart-title\" class=\"col--5\" placeholder=\"[Title]\" value=\""
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "\"/>\n      <input type=\"text\" id=\"chart-subtitle\" class=\"col--5\" placeholder=\"[Subtitle]\" value=\""
    ...
    + "      </select>\n      <br/>\n      <label>Legend</label>\n      <select id=\"chart-legend\" class=\"col--5\">\n"
    ...
    + "      </select>\n\n      <br/>\n      <label>Aspect Ratio</label>\n      <select id=\"aspect-ratio\" class=\"col--5\">\n"
    ...
    + "      </select>\n\n      <br/>\n      <input type=\"text\" id=\"chart-unit\" placeholder=\"[Unit]\" class=\"col--2\" value=\""
    ...
    + "\"/>\n      <input type=\"text\" id=\"chart-source\" placeholder=\"[Source]\" class=\"col--7\" value=\""
    ...
    + "\"/>\n\n      <br/>\n      <label>Time period (if applicable)</label>\n      <select id=\"chart-period\" class=\"col--5\">\n"
    + ((stack1 = (helpers.select || (depth0 && depth0.select) || alias1).call(depth0,(depth0 != null ? depth0.type : depth0),{"name":"select","hash":{},"fn":this.program(7, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
...
templates['workEdit'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<section class=\"panel workspace-edit\">\n  <div class=\"edit-accordion\">\n\n    <div class=\"edit-section\">\n      <div class=\"edit-section__head\">\n        <h1>Metadata</h1>\n        <p id=\"metadata-a\">Title | Contact | Abstract | Keywords</p>\n        <p id=\"metadata-b\">Title | Next release | Contact | Summary | NS status | Keywords</p>\n        <p id=\"metadata-d\">Title | Next release | Contact | Description | NS status | Keywords</p>\n      </div>\n      <div class=\"edit-section__content\">\n        <div id=\"metadata-list\">\n          <p>Title: <textarea class=\"auto-size\" type=\"text\" id=\"name\" cols=\"40\" style=\"box-sizing: border-box; min-height: 31px;\">"
    ...
    + "</textarea></p>\n          <p id=\"summary-p\">Summary: <textarea class=\"auto-size\" type=\"text\" id=\"summary\" cols=\"40\" style=\"box-sizing: border-box; min-height: 31px;\">"
    + alias2(alias1((depth0 != null ? depth0.summary : depth0), depth0))
    + "</textarea></p>\n          <p id=\"abstract-p\">Abstract: <textarea class=\"auto-size\" type=\"text\" id=\"abstract\" cols=\"40\" style=\"box-sizing: border-box; min-height: 31px;\">"
    ...
    + "</textarea></p>\n          <p id=\"description-p\">Description: <textarea class=\"auto-size\" type=\"text\" id=\"description\" cols=\"40\" style=\"box-sizing: border-box; min-height: 31px;\">"
    + alias2(alias1((depth0 != null ? depth0.description : depth0), depth0))
    + "</textarea></p>\n          <p>Keywords: <textarea class=\"auto-size\" type=\"text\" id=\"keywords\" cols=\"40\" style=\"box-sizing: border-box; min-height: 31px;\">"
    ...
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.download : depth0),{"name":"each","hash":{},"fn":this.program(15, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
