...
templates['chartBuilder'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"markdown-editor chart-builder\" xmlns=\"http://www.w3.org/1999/html\">\n  <div class=\"markdown-editor__header\">\n    <h1>Chart Builder</h1>\n  </div>\n  <div class=\"markdown-editor__content\">\n    <div id=\"preview-chart\" class=\"wmd-panel wmd-preview\">\n      <div id=\"chart\"></div>\n    </div>\n    <div id=\"edit-chart\" class=\"wmd-panel wmd-preview\">\n\n      <input type=\"text\" id=\"chart-title\" class=\"col--5\" placeholder=\"[Title]\" value=\""
    ...
    + ((stack1 = (helpers.select || (depth0 && depth0.select) || alias1).call(depth0,(depth0 != null ? depth0.period : depth0),{"name":"select","hash":{},"fn":this.program(7, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "      </select>\n\n    </div>\n  </div>\n  <div class=\"markdown-editor__footer\">\n    <button class=\"btn-chart-builder-cancel\">Cancel</button>\n    <button class=\"btn-chart-builder-create\">Save Chart</button>\n    <button class=\"btn-chart-png\">Generate PNG</button>\n  </div>\n</div>";
},"useData":true});
templates['chartBuilderBarlines'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "  <label>"
    ...
    return "      <option value=\"bar\" selected>Bar</option>\n      <option value=\"line\">Line</option>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1;
