...
class InteractiveCreate extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <form className={`form ${this.state.input.error ? " form__input--error" : ""}`} onSubmit={this.handleSubmit} name="create-new-team">
                ...
                */}
                ...
                <button className="btn btn--positive" disabled={this.state.isAwaitingResponse}>
                    Create
                </button>
                {this.state.isAwaitingResponse && <div className="form__loader loader loader--dark"></div>}
            </form>
        );
    }
}

InteractiveCreate.propTypes = propTypes;
