...
import InteractiveDeleteForm from "./InteractiveDeleteForm";
...
export class InteractiveDeleteController extends Component {
    constructor(props) {
        super(props);
...
InteractiveDeleteController.propTypes = propTypes;
...
export default connect(mapStateToProps)(InteractiveDeleteController);
