...
import { InteractiveDeleteController } from "./InteractiveDeleteController";
...
test("User is given a notification if the team delete fails", async () => {
    ...
    const component = shallow(<InteractiveDeleteController {...defaultProps} />);
    const inputEvent = {
        target: {
            value: "Test Team",
        },
...
test("Parent path is the team path with '/delete' removed", () => {
    ...
    const component1 = shallow(<InteractiveDeleteController {...props1} />);
    ...
    const component2 = shallow(<InteractiveDeleteController {...props2} />);
    ...
    const component3 = shallow(<InteractiveDeleteController {...props3} />);
