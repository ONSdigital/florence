...
import InteractiveEdit from "./InteractiveEdit";
...
export class InteractiveEditController extends Component {
    constructor(props) {
        super(props);
    ...
    handleUsersSearch = event => {
        ...
        const filteredUsers = this.props.users.filter(user => {
            ...
            return user.email.toLowerCase().search(searchTerm) !== -1 && !isTeamMember;
        });
        this.setState({
    ...
    handleMembersChange = userAttributes => {
        ...
        switch (userAttributes.action) {
            case "remove": {
                teams
                    .removeMember(this.props.name, userAttributes.email)
                    .then(() => {
            ...
            case "add": {
                teams
                    .addMember(this.props.name, userAttributes.email)
                    .then(() => {
...
InteractiveEditController.propTypes = propTypes;
...
export default connect(mapStateToProps)(InteractiveEditController);
