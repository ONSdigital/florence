...
export class NavbarComponent extends Component {
    render() {
        return (
            <header className="ons-header " role="banner">
                        ...
                        <div className="ons-header__grid-top ons-grid ons-grid--gutterless ons-grid--flex ons-grid--between ons-grid--vertical-center ons-grid--no-wrap">
                            <div className="ons-grid__col ons-col-auto">
                                <div className="ons-header__logo--large">
                                    <a className="ons-header__logo-link" href="#0">
                                        <svg className="ons-svg-logo" xmlns="http://www.w3.org/2000/svg" width="197"
                                             height="19" viewBox="33 2 552 60">
                                            <title id="ons-logo-en-alt">Office for National Statistics logo</title>
                                            <g className="ons-svg-logo__group ons-svg-logo__group--secondary"
                                               fill="#a8bd3a">
                                                <path
                                            ...
                                            <g className="ons-svg-logo__group ons-svg-logo__group--primary"
                                               fill="#003c57">
                                                <path
                                            ...
                                            <g className="ons-svg-logo__group ons-svg-logo__group--text"
                                               fill="#003c57">
                                                <path
                                ...
                                <div className="ons-header__logo--small">
                                    <a className="ons-header__logo-link" href="#0">
                                        <svg className="ons-svg-logo" xmlns="http://www.w3.org/2000/svg" width="120"
                                             height="27" viewBox="0 5 595 116">
                                            <title id="ons-logo-stacked-en-alt">Office for National Statistics
                                                logo</title>
                                            <g className="ons-svg-logo__group ons-svg-logo__group--secondary"
                                               fill="#a8bd3a">
                                                <path
                    ...
                    <div className="ons-container">
                        <div
                            ...
                            <div className="ons-grid__col ons-col-auto ons-u-flex-shrink">
                                <a className="ons-header__title-link" href="#0">
                                    <div className="ons-header__title">Manage my interactives</div>
                                </a>
                            </div>
                        </div>
                    </div>
