...
import AddMembersToGroup from "./AddMembersToGroup.test";
...
describe("AddMembersToGroup", () => {
    it("matches the snapshot", () => {
        const wrapper = renderer.create(<AddMembersToGroup.WrappedComponent {...defaultProps} params={{ router: setRouteLeaveHook }} />);
        expect(wrapper.toJSON()).toMatchSnapshot();
    });

    it("requests user data on component load", () => {
        render(<AddMembersToGroup.WrappedComponent {...defaultProps} params={{ id: "test.user-1498@ons.gov.uk", router: setRouteLeaveHook }} />);
    ...
    describe("when loading data", () => {
        it("shows spinner", () => {
            ...
            render(<AddMembersToGroup.WrappedComponent {...props} params={{ id: "", router: setRouteLeaveHook }} />);
    ...
    describe("where user and groups fetched", () => {
        it("shows user details", () => {
            render(<AddMembersToGroup.WrappedComponent {...props} params={{ id: "test.user-1498@ons.gov.uk", router: setRouteLeaveHook }} />);
            expect(screen.getByText(/Back/i)).toBeInTheDocument();
