...
function AddMembersToGroup(props) {
    ...
    const { isNewSignIn, loading, user, groups, loadUser, loadingGroups, loadGroups, AddMembersToGroup, isAdding, rootPath } = props;
                ...
                <div className="grid grid--justify-space-between">
                    <div className="grid__col-md-5">
                        {loading ? (
                            ...
                            <Members {...user} userGroups={userGroups} handleRemove={handleRemove} />
                        )}
                    </div>
...
export default withRouter(AddMembersToGroup);
