...
export class TeamDeleteController extends Component {
    ...
    handleFormSubmit(event) {
        ...
        if (this.state.input.value !== this.props.name) {
            log.event(`error deleting team. The team name provided doesn't match the one user is trying to delete`, log.data({'user-inputted-value': this.state.input.value, "team": this.props.name}));
            const input = Object.assign({}, this.state.input, {
