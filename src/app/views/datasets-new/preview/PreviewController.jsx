    ...
    getDataset = datasetID => {
        ...
        return datasets
            ...
            .then(datatset => {
                this.setState({
                    isFetchingDataset: false,
                    dataset: this.mapDatasetToState(datatset)
                });
            })
            .catch(error => {
                switch (error.status) {
            ...
            <div>
                <div className="grid grid--justify-center">
                    <div className="grid__col-6 margin-bottom--1">
                        ...
                        <p className="margin-bottom--1 font-size--18">
                            <span className="font-weight--600">Edition</span>: {this.props.params.editionID}
                        </p>
                        <p className="margin-bottom--1 font-size--18">
                            <span className="font-weight--600">Version</span>: {this.props.params.versionID}
                        </p>
                    </div>
                </div>
