    ...
    render() {
        return (
            <DatasetPreview 
                ...
                previewURL={this.props.latestVersion ? `//${location.host}${this.props.latestVersion}`: null}
...
function mapStateToProps(state) {
    return {
        ...
        latestVersion: (state.state.datasets.activeDataset && state.state.datasets.activeDataset.links.latest_version) ? url.resolve(state.state.datasets.activeDataset.links.latest_version.href) : null,
