...
function mapStateToProps(state) {
    return {
        ...
        versionURL: (state.state.datasets.activeDataset && state.state.datasets.activeDataset.links.latest_version) ? url.resolve(state.state.datasets.activeDataset.links.latest_version.href) : null,
