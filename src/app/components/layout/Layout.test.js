...
import SessionManagement, { createDefaultExpireTimes, convertUTCToJSDate } from "dis-authorisation-client-js";
...
it("should start the session timer if there is an expired access token & the session state is false", async () => {
    ...
    const actual = convertUTCToJSDate(mockSessionExpiryTime);
