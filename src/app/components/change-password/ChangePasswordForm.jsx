            ...
            <div>
                ...
                <form onSubmit={this.props.formData.onSubmit}>
                    ...
                    <div className="modal__footer">
                        <button className="btn btn--positive" type="submit" onClick={this.props.formData.onSubmit} disabled={isSubmitting}>
                            Update password
                        </button>
                        <button className="btn margin-left--1" type="button" onClick={this.props.formData.onCancel} disabled={isSubmitting}>
                            Cancel
                        </button>
