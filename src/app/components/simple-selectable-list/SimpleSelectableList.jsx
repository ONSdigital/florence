...
const propTypes = {
    rows: PropTypes.arrayOf(
        PropTypes.shape({
            ...
            extraDetails: PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.shape({ content: PropTypes.oneOfType[PropTypes.string, PropTypes.object], classes: PropTypes.string }))),
        })
    ).isRequired,
