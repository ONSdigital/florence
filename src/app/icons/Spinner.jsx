...
const Spinner = ({ classes = "ons-svg-icon ons-u-ml-xs", viewBox = "0 0 100 100", fill = "currentcolor" }) => {
    return (
        <svg className={classes} xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox={viewBox} preserveAspectRatio="xMidYMid" fill={fill}>
