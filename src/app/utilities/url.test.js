...
describe("Resolved URLs include query parameters", () => {
    it("includes queries on routes from the root path", () => {
        expect(url.resolve("/datasets/my-dataset/editions/current/versions/1?collection=my-collection")).toBe(
            "/florence/datasets/my-dataset/editions/current/versions/1?collection=my-collection"
        );
    });
