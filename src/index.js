...
import {InteractivesController, InteractivesFormController, InteractivesDeleteController} from "./app/views/interactives";
            ...
            <Router history={history}>
                <Route component={Layout}>
                    ...
                    <Route path={`${rootPath}/interactives`}>
                        ...
                        <Route path="delete/:interactiveId" component={userIsAuthenticated(InteractivesDeleteController)} />
                    </Route>
